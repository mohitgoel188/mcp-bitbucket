...
class TestBitbucketApiTools(unittest.TestCase):
    def setUp(self):
        ...
        # Sample test data
        self.test_workspace = "testworkspace"
        ...
        self.mocks = {
            method: patcher.start() for method, patcher in self.patches.items()
        }
    ...
    def test_create_repository(self):
        ...
        mock_data = {
            "links": {"html": {"href": "https://bitbucket.org/testworkspace/test-repo"}}
        }
    ...
    def test_create_issue(self):
        ...
        mock_data = {
            ...
            "links": {
                "html": {
                    "href": "https://bitbucket.org/testworkspace/test-repo/issues/1"
                }
            },
        }
        self.mocks["post"].return_value = self._mock_response(201, mock_data)
    ...
    def test_create_pull_request(self):
        ...
        mock_data = {
            ...
            "links": {
                "html": {
                    "href": "https://bitbucket.org/testworkspace/test-repo/pull-requests/1"
                }
            },
        }
        self.mocks["post"].return_value = self._mock_response(201, mock_data)
    ...
    def test_create_branch(self):
        ...
        response = requests.post(
            ...
            auth=("test_user", "test_password"),
            json={"name": "feature-branch", "target": {"hash": "main"}},
        )
    ...
    def test_get_pull_request(self):
        ...
        mock_pr_data = {
            ...
            "links": {
                "html": {
                    "href": "https://bitbucket.org/test/test-repo/pull-requests/123"
                }
            },
        }

        self.mocks["get"].return_value = self._mock_response(200, mock_pr_data)

        response = requests.get(
            f"https://api.bitbucket.org/2.0/repositories/{self.test_workspace}/{self.test_repo_slug}/pullrequests/123",
            auth=("test_user", "test_password"),
        )

        self.assertEqual(response.status_code, 200)
        pr_data = response.json()
        self.assertEqual(pr_data["id"], 123)
    ...
    def test_get_pull_request_not_found(self):
        ...
        self.mocks["get"].return_value = self._mock_response(
            404, {"error": {"message": "Not found"}}
        )

        response = requests.get(
            f"https://api.bitbucket.org/2.0/repositories/{self.test_workspace}/{self.test_repo_slug}/pullrequests/999",
            auth=("test_user", "test_password"),
        )
    ...
    test_results["tests"] = [
        {
            ...
            "output": details["output"].getvalue()
            if hasattr(details["output"], "getvalue")
            else str(details["output"]),
